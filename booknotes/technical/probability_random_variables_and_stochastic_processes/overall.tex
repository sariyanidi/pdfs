...
\section{Re-do}
\begin{itemize}
\item Bernoulli's Theorem (page \#58).
\end{itemize}
...
\item \textbf{Example 4-12} - Prove Poisson points -  \ie how to show that the probability \item \textbf{Example 4-16} - Prove that if a discrete RV is memoryless then it must be geometric
\item \textbf{Example 4-19} - Nice recap for Bayesian 
of having $k$ events in an interval is given by Poisson distribution?
\item \textbf{Theorem 4-2} - De Moivre - Laplace Theorem 
...
\begin{itemize}
\item What RV transformation shall we apply to go from $F_x(x)$ to a uniform distribution (page \#139)?
\item The same as above but from uniform to $F_y(y)$?
\item Re-read Theorem 5-1 (page \#142)
\item Re-do: how to obtain eq. 5-73 -- the $n$th moment of a Gaussian RV?
\item Re-prove: Chebyshev inequality (page \#151)
\item Re-prove: Markov inequality (page \#151)
\item Re-prove: Bienayme inequality (page \#152)
\item Re-prove: Lyapunov inequality (page \#152)
\item Re-prove: De Moivre - Laplace theorem (page \#156)
\end{itemize}
