...
\begin{itemize}
\item \textbf{L.17.1.3.} Let $\{\mb U_1, \dots, \mb U_r\}$ be a linearly independent set in $\mathcal{U}$ and $\{\mb V_1, \dots, \mb V_s\}$ be two sets of linearly independent matrices in $\mathcal{U}$ and $\mathcal{V}$. If $\mathcal{U}$ and $\mathcal{V}$ are essentially disjoint, then the combined set $\{\mb U_1,\dots,\mb U_r, \mb V_1, \dots, \mb V_s\}$ is also linearly independent.
\end{itemize}
...
\item \textbf{L17.2.3} If $\mathcal{C}(\mb A)$ and $\mathcal{C}(\mb B)$ are essentially disjoint, then $\mb{AK} = \mb{BL} = )$ for any $\mb{K,L}$.
